...
import {
  createProjectWithCsv,
  generateQuestions as generateProjectQuestions,
  uploadCommentsBulk,
} from "../config/api";
import type {
  CommentInput,
...
const CsvUploadPage: React.FC = () => {
  ...
  const processInBatches = useCallback(
    ...
    [currentProjectId, skipDuplicates],
  );
  ...
  }, [currentProjectId, selectedFile, previewData, processInBatches]);
